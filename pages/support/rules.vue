<template>
    <div class="content">
        ...
        <div class="block">
            ...
            <blockquote class="mono-font code-text has-text-weight-bold is-size-6">
            ...
            <h3>Suit length based on a range interval</h3>
            <p>
            ...
            <h3>Cards of suit to include and/or exclude</h3>
